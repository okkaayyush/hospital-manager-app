...
import {
  ...
  Clock, Save, Inbox, TriangleAlert, X, Menu
} from 'lucide-react';
    ...
    <div style={{
      ...
      <div style={{display:'flex',flexDirection:'column',flex:1}}>
        ...
        <nav style={{display:'flex',flexDirection:'column',gap:'2px'}}>
          ...
          <button style={view==='profile'?s.navActive:s.nav}
      ...
      <div style={{...s.main,...(isMobile?{padding:0}:{})}}>
        ...
        {isMobile && (
          <div style={s.mobileTopBar}>
            ...
            {pendingCount > 0
              ? <span style={{...s.navBadge,background:'#ef4444'}}>{pendingCount}</span>
        ...
        <div style={{padding: isMobile?'16px':'36px 40px'}}>
          ...
          {view === 'appointments' && (
            <div>
              <div style={s.pageHeader}>
                <div>
                  <h2 style={{...s.heading,...(isMobile?{fontSize:'18px'}:{})}}>Appointments</h2>
              ...
              {!profile && (
                <div style={s.warning}>
                  ...
                  Create your profile first, then ask admin to approve it.
                </div>
              )}
              ...
              {appointments.map(apt => {
                ...
                return (
                  <div key={apt._id} style={{
                    ...
                    <div style={{
                      ...s.aptRight,
                      ...(isMobile?{width:'100%',flexDirection:'row',justifyContent:'space-between',alignItems:'center'}:{})
                    }}>
          ...
          {view === 'profile' && (
            <div style={{maxWidth: isMobile?'100%':'520px'}}>
              <div style={s.pageHeader}>
                <div>
                  <h2 style={{...s.heading,...(isMobile?{fontSize:'18px'}:{})}}>My Profile</h2>
              ...
              {profile ? (
                <div style={s.card}>
                  <div style={{...s.profileSection,...(isMobile?{flexDirection:'column',alignItems:'center',textAlign:'center'}:{})}}>
                    <PhotoUpload
                    ...
                    <div style={{flex:1,...(isMobile?{width:'100%'}:{})}}>
                      <h3 style={{margin:'0 0 8px 0',color:'#f1f5f9',fontSize:'16px',fontWeight:'600'}}>
                        Dr. {user.name}
                      </h3>
                      <div style={{display:'flex',flexDirection:'column',gap:'5px',...(isMobile?{alignItems:'center'}:{})}}>
